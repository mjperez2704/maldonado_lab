...
export default function DoctorsTable({ initialDoctors }: { initialDoctors: Doctor[] }) {
    ...
    const handleDeleteConfirmation = async () => {
        ...
        try {
            ...
            loader.stop();
            setDoctorToDelete(null); // Reset after operation
        }
    };
    ...
    return (
        <AlertDialog onOpenChange={(open) => !open && setDoctorToDelete(null)}>
                        ...
                        <TableCell>
                            <div className="flex items-center justify-end gap-2">
                                ...
                                <AlertDialogTrigger asChild>
                                    <Button variant="destructive" size="icon" onClick={() => setDoctorToDelete(item)}>
