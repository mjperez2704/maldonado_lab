...
import { deleteBranch, Branch } from '@/services/branchService';
...
export default function BranchesTable({ initialBranches }: { initialBranches: Branch[] }) {
  ...
  const handleEdit = (id: number) => {
    router.push(`/sucursales/editar/${id}`);
  };
    ...
    <div className="flex flex-col gap-4">
      ...
      <div className="overflow-x-auto">
          <Table>
              ...
              <TableRow>
                  ...
                  <TableHead>
                       <Button variant="ghost" size="sm">Teléfono <ArrowUpDown className="ml-2 h-4 w-4" /></Button>
                  </TableHead>
              ...
              {branches.map((branch, index) => (
                  ...
                  <TableCell>
                      ...
                      <Button variant="outline" size="icon" onClick={() => handleEdit(branch.id)}>
                          <Pencil className="h-4 w-4" />
                      </Button>
                      <Button variant="destructive" size="icon" onClick={() => handleDelete(branch.id)}>
      ...
      <div className="flex justify-between items-center">
          <div className="text-sm text-muted-foreground">
              Mostrando 1 a {branches.length} de {branches.length} registros
          </div>
          <Pagination>
              <PaginationContent>
                  <PaginationItem>
