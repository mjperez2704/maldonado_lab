...
export default function ProductsTable({ initialProducts }: { initialProducts: ProductWithValue[] }) {
    const [products, setProducts] = useState<ProductWithValue[]>(initialProducts);
        ...
        <div className="overflow-x-auto">
            <Table>
                ...
                <TableRow>
                    ...
                    <TableHead>
                            <Button variant="ghost" size="sm">Inicial <ArrowUpDown className="ml-2 h-4 w-4" /></Button>
                    </TableHead>
                    <TableHead>Compras</TableHead>
                    <TableHead>En</TableHead>
                    <TableHead>Afuera</TableHead>
