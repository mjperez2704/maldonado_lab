...
export default function SettingsPage() {
    ...
    const [reportSettings, setReportSettings] = useState<ReportSettings>({
        ...
        branchName: { color: "#000000", font: "sans-serif", size: "12" },
        branchInfo: { color: "#000000", font: "sans-serif", size: "12" },
        patientTitle: { color: "#000000", font: "sans-serif", size: "12" },
        patientData: { color: "#000000", font: "sans-serif", size: "12" },
        testTitle: { color: "#000000", font: "sans-serif", size: "12" },
        testName: { color: "#000000", font: "sans-serif", size: "12" }
    });
